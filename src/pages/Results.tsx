  ...
  const resultsData: Record<string, StudentResultCardProps[]> = {
    "2019-2020": [
      ...
      },
      {
        ...
        marks: "460/600",
        percentage: "77%",
        image: "/assets/arthi.jpg",
        subjects: [{ name: "Tamil", score: "81/100" },
          { name: "English", score: "71/100" },
          { name: "Economics", score: "81/100" },
          { name: "Commerce", score: "84/100" },
          { name: "Accountancy", score: "75/100" },
          { name: "Computer Application", score: "84/100" },], // add subject list here when available
      },
      {
        name: "T. Rakesh",
        grade: "XII-Com",
        ...
        percentage: "81%",
        image: placeholderImg,
        subjects: [{ name: "Tamil", score: "71/100" },
          { name: "English", score: "81/100" },
          { name: "Economics", score: "81/100" },
          { name: "Commerce", score: "84/100" },
          { name: "Accountancy", score: "85/100" },
          { name: "Business Mathematics and Statistics", score: "84/100" },], // add subject list here when available
      },
    ],
    "2020-2021": [
      {
      ...
      },
      {
        ...
        subjects: [{ name: "Tamil", score: "87/100" },
          ...
          { name: "Economics", score: "90/100" },
          { name: "Commerce", score: "86/100" },
          { name: "Accountancy", score: "97/100" },
          { name: "Computer Application", score: "94/100" },], // add subject list here when available
      },
    ],
    "2021-2022": [
        {
      ...
      },
      {
      ...
      },
       {
        ...
        percentage: "87.5%",
        image: placeholderImg,
        subjects: [{ name: "Tamil", score: "89/100" },
          { name: "English", score: "84/100" },
          { name: "Mathematics", score: "96/100" },
          { name: "Physics", score: "82/100" },
          { name: "Chemistry", score: "83/100" },
          { name: "Computer Science", score: "91/100" },],
      },
       {
        name: "S. Santhosh",
        grade: "XII SCI",
        ...
        subjects: [{ name: "Tamil", score: "74/100" },
          { name: "English", score: "64/100" },
          { name: "Mathematics", score: "72/100" },
          { name: "Physics", score: "70/100" },
          { name: "Chemistry", score: "73/100" },
          { name: "Computer Science", score: "81/100" },],
      },
    ],
    "2022-2023": [
      {
